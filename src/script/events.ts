import { IScrollChangeEventArgs, ISelectionChangeEventArgs, NodeModel, randomId, UserHandleEventsArgs } from "@syncfusion/ej2-angular-diagrams";
...
export class DiagramClientSideEvents {
    ...
    public enableItems() {
        ...
        assistantBtn.style.cssText = 'background-color: #0078d4; border-color: #0078d4; color: #fff; pointer-events: auto !important; opacity:1';
    ...
    public disableItems() {
        ...
        let assistantBtn = (document.getElementById('addAssistantBtn') as any);
        assistantBtn.style.cssText = 'background-color: #0078d4; border-color: #0078d4; color: #fff;  pointer-events: none !important; opacity:0.5';
        let colorItems = document.getElementsByClassName('item-singleSelectColor');
