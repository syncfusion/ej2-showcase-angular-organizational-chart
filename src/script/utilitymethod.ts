...
import { Diagram, DiagramTools, ImageElement, NodeModel, PathElement, StackPanel, TextElement } from "@syncfusion/ej2-angular-diagrams";
import { SelectEventArgs } from "@syncfusion/ej2-angular-dropdowns";
import { SelectedEventArgs, SliderChangeEventArgs } from "@syncfusion/ej2-angular-inputs";
import { MenuEventArgs } from "@syncfusion/ej2-angular-navigations";
import { expandIcon } from "../app/home/home.component";
...
export class UtilityMethods {
    ...
    public modifyNodeTemplate(args: any) {
        let expandable = (document.getElementById('expandable') as any);
        expandable = expandable.childNodes[0].firstChild.ej2_instances[0];
    ...
    public updateNodeTemplate(newValue: any, template: any) {
        ...
        diagram.refresh();
        diagram.fitToPage({ mode: 'Page', region: 'Content' });
        this.updateDiagramViews(diagram);
    }

    public updateDiagramViews(diagram: Diagram) {
